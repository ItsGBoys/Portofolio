...
// Temukan elemen tombol berdasarkan ID
var favGameButton = document.getElementById("favGameButton");

// Tambahkan event listener untuk menanggapi klik tombol
favGameButton.addEventListener("click", function() {
  // Mengalihkan pengguna ke URL yang ditentukan
  window.location.href = "https://github.com/ItsGBoys/4you";
});